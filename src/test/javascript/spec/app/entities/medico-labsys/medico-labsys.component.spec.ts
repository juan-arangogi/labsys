...
import { MedicoLabsysComponent } from 'app/entities/medico-labsys/medico-labsys.component';
...
describe('Component Tests', () => {
    describe('MedicoLabsys Management Component', () => {
        let comp: MedicoLabsysComponent;
        let fixture: ComponentFixture<MedicoLabsysComponent>;
        let service: MedicoLabsysService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [LabsysTestModule],
                declarations: [MedicoLabsysComponent],
                providers: [
                    {
                ...
                .overrideTemplate(MedicoLabsysComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(MedicoLabsysComponent);
