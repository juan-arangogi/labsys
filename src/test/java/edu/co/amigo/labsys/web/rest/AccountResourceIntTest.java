...
import edu.co.amigo.labsys.config.Constants;
import edu.co.amigo.labsys.domain.Authority;
import edu.co.amigo.labsys.domain.User;
import edu.co.amigo.labsys.repository.AuthorityRepository;
import edu.co.amigo.labsys.repository.UserRepository;
import edu.co.amigo.labsys.security.AuthoritiesConstants;
import edu.co.amigo.labsys.service.MailService;
import edu.co.amigo.labsys.service.UserService;
import edu.co.amigo.labsys.service.dto.PasswordChangeDTO;
import edu.co.amigo.labsys.service.dto.UserDTO;
import edu.co.amigo.labsys.web.rest.errors.ExceptionTranslator;
import edu.co.amigo.labsys.web.rest.vm.KeyAndPasswordVM;
import edu.co.amigo.labsys.web.rest.vm.ManagedUserVM;
