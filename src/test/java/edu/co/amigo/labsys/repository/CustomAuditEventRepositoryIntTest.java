...
import edu.co.amigo.labsys.config.audit.AuditEventConverter;
import edu.co.amigo.labsys.domain.PersistentAuditEvent;
...
import static edu.co.amigo.labsys.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
