...
@Component({
    selector: 'jhi-paciente-labsys',
    templateUrl: './paciente-labsys.component.html'
})
export class PacienteLabsysComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.pacienteService
            ...
            .subscribe(
                (res: HttpResponse<IPacienteLabsys[]>) => this.paginatePacientes(res.body, res.headers),
    ...
    trackId(index: number, item: IPacienteLabsys) {
        return item.id;
    }
    ...
    private paginatePacientes(data: IPacienteLabsys[], headers: HttpHeaders) {
