...
/**
 * Service Implementation for managing Recipiente.
 */
@Service
@Transactional
public class RecipienteService {
    ...
    public RecipienteService(RecipienteRepository recipienteRepository, RecipienteMapper recipienteMapper) {
    ...
    public RecipienteDTO save(RecipienteDTO recipienteDTO) {
        ...
        return recipienteMapper.toDto(recipiente);
    }
